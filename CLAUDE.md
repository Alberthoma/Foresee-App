...
- **Versión activa:** `V FSA 0057` (2026-06-27)
- **Próxima versión:** `V FSA 0058`
- **Archivo de trabajo:** `index.html` (raíz del proyecto — único archivo que se edita)
- **Último backup:** `Backup\antes de V FSA 0057 — 2026-06-27.html`
- **Último informe:** `Informes de actualización\V FSA 0057 — 2026-06-27.md`
